...
const Footer = () => {
    return (
        <footer className={`lg:flex-row flex-col bg-base-200 p-10 flex justify-evenly`}>
            <div>
                <aside className='flex flex-col justify-center items-center gap-2'>
                    <div>
                        <img src="/images/logo.jpeg" className='w-20' alt="" />
                    </div>
                    {/* <p className="font-bold">Product Recommendation System</p> */}
                    <p className="font-bold">A smart way to find recommended products</p>
                    <p>
